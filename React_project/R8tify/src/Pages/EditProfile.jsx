...
const EditProfile = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center p-4">
      ...
      <div className="bg-black w-[527px] h-[500px] rounded-[57px] mt-5 p-8">
  ...
  <label htmlFor="file-input" className="cursor-pointer flex">
    ...
    />
          ...
          <div className="mt-6">
            ...
            <input type="text" name="phone" value={profile.phone} onChange={handleChange} className="w-[400px] h-10 mt-1 ml-4 rounded-lg p-2 bg-white"   required />
          </div>

          <button type="submit" className="w-[150px] h-[50px] mt-6 ml-[160px] rounded-full border-2 border-black bg-white text-black font-bold cursor-pointer">Submit</button>
        </form>
      </div>
